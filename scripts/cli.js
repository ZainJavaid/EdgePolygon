...
const contractABI = require("../artifacts/contracts/Edgepolygonlink.sol/Edgepolygonlink.json").abi;

program
    .name("edgepolygonlink-cli")
    .description("CLI tool for Edgepolygonlink smart contract")
    .version("1.0.0");
